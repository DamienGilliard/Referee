...
int main()
{
    ...
    poseAsVector[2] = M_PI / 2; // 90 degrees rotation around Z axis
    ...
    Eigen::Matrix3d rotationMatrix = Eigen::AngleAxisd(poseAsVector[2], Eigen::Vector3d::UnitZ()).toRotationMatrix();
